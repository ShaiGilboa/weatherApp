...
const Loading : React.FC<PropsWithChildren<props>> = () => {
  ...
  return (
    <div className="preloader" style={{opacity: 1}} data-css="https://codepen.io/tholman/pen/yenku">
      <svg version="1.1" id="sun" x="0px" y="0px" 
       viewBox="0 0 10 10" enableBackground="new 0 0 10 10">
      <g>
    ...
    <svg version="1.1" id="cloud" x="0px" y="0px" style={{width:"10px", height:"10px"}} viewBox="0 0 10 10" enableBackground="new 0 0 10 10" >
